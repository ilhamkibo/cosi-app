<footer
    class="mb-5 xl:px-0 px-5  max-w-6xl mx-auto flex flex-shrink flex-col items-start justify-start w-full h-full {{ Route::currentRouteName() == 'home' ? 'text-white' : 'text-black' }}">
    <div class="flex flex-col gap-10 sm:gap-0 sm:flex-row flex-wrap justify-between items-center w-full ">
        <div class="flex flex-row gap-10">
            <div>
                <div>
                    ...
                    <ul>
                        <li class="ml-4 py-1">
                            <a href="https://wa.me/6281291999605" target="_blank"
                                class="flex items-center gap-2 {{ Route::currentRouteName() == 'home' ? 'hover:text-gray-200 text-white' : 'hover:text-gray-700 text-black' }} hover:scale-105 transition-transform duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24"
                                    style="enable-background:new 0 0 24 24;" xml:space="preserve"
                                    class="size-5 {{ Route::currentRouteName() == 'home' ? 'fill-white' : 'fill-black' }} hover:fill-gray-200">
                                    <g id="WA_Logo">
                                        <g>
                        ...
                        <li class="ml-4 py-1">
                            <a href="mailto:contact@cosi.co.id" target="_blank"
                                class="flex items-center gap-2 {{ Route::currentRouteName() == 'home' ? 'hover:text-gray-200 text-white' : 'hover:text-gray-700 text-black' }} hover:scale-105 transition-transform duration-300 ease-in-out">
                ...
                <div class="mt-4">
                    ...
                    <ul class="list-none">
                        <li class="ml-4 py-1">
                            <a href="https://www.instagram.com/cosi.id/" target="_blank"
                                class="flex items-center gap-2 {{ Route::currentRouteName() == 'home' ? 'hover:text-gray-200 text-white' : 'hover:text-gray-700 text-black' }} hover:scale-105 transition-transform duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24"
                                    style="enable-background:new 0 0 24 24;" xml:space="preserve"
            ...
            <div>
                <p class="hover:text-gray-400 hover:scale-105 transition-transform duration-300 ease-in-out"><a
                        href={{ route('products.index') }}>Products</a></p>
                <p class="hover:text-gray-400 hover:scale-105 transition-transform duration-300 ease-in-out mt-2"><a
                        href={{ route('about') }}>About Us</a></p>
                <p class="hover:text-gray-400 hover:scale-105 transition-transform duration-300 ease-in-out mt-2"><a
                        href={{ route('articles.index') }}>Articles</a></p>
                <p class="hover:text-gray-400 hover:scale-105 transition-transform duration-300 ease-in-out mt-2"><a
    ...
    <p class="mt-4 xl:p-0 xl:px-0">
        <small class="font-light">Copyright © 2021 - {{ now()->year }} {{ config('app.name') }}. All Rights
            Reserved.</small>
    </p>
</footer>
