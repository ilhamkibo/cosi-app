        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-articles" class="hidden py-2 space-y-2 ">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-blue-200 dark:text-white dark:hover:bg-gray-700">Insert
                            New Article</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul id="dropdown-sales" class="hidden py-2 space-y-2 ">
                    <li>
                        <a href="#"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-blue-200 dark:text-white dark:hover:bg-gray-700">Input
                            Sales</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-blue-200 dark:text-white dark:hover:bg-gray-700">Invoice</a>
                    </li>
                    <li>
                        <a href="#"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-blue-200 dark:text-white dark:hover:bg-gray-700">Summary</a>
